...
[switch]: https://github.com/Adubbz/Ghidra-Switch-Loader
...
- Download the [switch-loader][switch]

## Setup

Launch Ghidra: ./ghidraRun (ghidraRun.bat for Windows)or launch PyGhidra:
./support/pyghidraRun (support\pyghidraRun.bat for Windows)
...
After importation launch the file and click on yes for analyze, Dont forgot do select (IPC)Switch loader and go (this can take a while, just wait)
