...
set(CMAKE_C_COMPILER "${DREAD_CLANG}/bin/clang")
set(CMAKE_C_COMPILER_TARGET ${NX64_TRIPLE})
set(CMAKE_CXX_COMPILER "${DREAD_CLANG}/bin/clang++")
...
if (DEFINED DREAD_LINKER)
    message(STATUS "Using custom linker: ${DREAD_LINKER}")
    add_link_options(-fuse-ld=${DREAD_LINKER})
    if (DEFINED DREAD_LINKER_FLAGS)
        add_link_options(${DREAD_LINKER_FLAGS})
    endif()
else()
